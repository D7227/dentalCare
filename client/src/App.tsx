...
import DashboardContent from "./doctor/pages/DashboardContent";
// import OrdersHistory from './components/orders/OrdersHistory';
import ScanBookingContent from "./doctor/pages/ScanBookingContent";
import PickupRequestsContent from "./doctor/pages/PickupRequestsContent";
import BillingContent from "./doctor/pages/BillingContent";
import ChatContent from "./doctor/pages/ChatContent";
import TeamManagementContent from "./doctor/pages/TeamManagementContent";
import ProfileContent from "./doctor/pages/ProfileContent";
