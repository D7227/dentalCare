...
const AdminHeader = ({ title, onMobileMenuToggle }: HeaderProps) => {
  return (
    <header
      className="bg-background border-b border-border px-8 lg:px-6 py-4 flex items-center justify-between sticky top-0 z-40 shadow-sm "
      style={{
