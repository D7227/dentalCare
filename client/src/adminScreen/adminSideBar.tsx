...
const AdminSideBar = ({
  ...
  const adminMenuItems = [
    ...
    },
    {
      ...
      id: "technician_management",
      link: "/admin/technician-management",
    },
    {
      icon: FileText,
      label: "Daily Reports",
    ...
    },
    {
      ...
      link: "/admin/accessory-management",
    },
    {
      icon: CreditCard,
      label: "Billing Management",
      id: "billing_management",
      link: "/admin/billing-management",
    },
    {
      icon: Calendar,
      label: "Scan Appointments",
      id: "scan_appointments",
      link: "/admin/scan-appointments",
    },
    {
      icon: MessageSquare,
      label: "Communication",
    ...
    { icon: Database, label: "Masters", id: "masters", link: "/admin/masters" },
    {
      icon: Shield,
      label: "Permissions",
      id: "permissions",
            ...
            <button
              ...
              className={cn(
                ...
                isCollapsed
                  ...
                  : "gap-3 px-3 py-3 rounded-lg text-sm font-medium hover:bg-gray-100 dark:hover:bg-gray-800",
                isActive &&
                  (isCollapsed
