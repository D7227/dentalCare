...
const Register = () => {
  ...
  React.useEffect(() => {
    ...
    billingSameAsClinic,
    formData.clinicAddressLine1,
    formData.clinicAddressLine2,
    formData.clinicCity,
    formData.clinicState,
    formData.clinicPincode,
    formData.clinicCountry,
  ]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "Your clinic has been registered successfully. You are now logged in.",
      });
      navigate("/");
    } catch (error) {
      toast({
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <Card className="w-full max-w-2xl">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Create your clinic account to get started with our dental lab
            management system
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <Label htmlFor="clinicLicenseNumber">
                Clinic License Number *
              </Label>
              <Input
            ...
            <div className="pt-4">
              <h3 className="font-semibold">Clinic Address Details</h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
