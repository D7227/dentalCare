...
interface ImplantTypeSelectorProps {
  ...
  setImplantSelections: React.Dispatch<
    React.SetStateAction<ImplantSelectionsState>
  >;
...
const ImplantTypeSelector: React.FC<ImplantTypeSelectorProps> = ({
  ...
  const [localAbutmentMaterial, setLocalAbutmentMaterial] = useState<
    string | null
  >(null);
  ...
  const handleSave = () => {
    ...
    const product: { name: string; provider: string }[] = Object.entries(
      localProviders
  ...
  return (
    <>
      {formData?.abutmentDetails?.abutmentType &&
        formData?.abutmentDetails?.product?.length > 0 && (
            ...
            <div className="text-gray-800 text-sm">
              ...
              <div className="mt-2">
                ...
                <ul className="list-disc ml-5">
                  {formData.abutmentDetails.product.map(
                    (p: any, idx: number) => (
                      <li key={idx}>
                        {p.name}: {p.provider}
                      </li>
      ...
      {(editMode || !formData?.abutmentDetails?.abutmentType) && (
        <div className="mb-6 p-4 bg-gray-50 rounded-lg border">
          ...
          <div className="flex flex-row gap-4 items-center">
            {["screw-retained", "cement-retained", "screwmentable"].map(
              (val) => (
                <label
                  key={val}
                  className="flex items-center justify-between p-3 border rounded-lg cursor-pointer hover:bg-green-50 transition-colors mt-0 gap-3"
                >
      ...
      >
          ...
          {selectedItemValue === "screw-retained" && (
            <>
              ...
              <div className="flex gap-2">
                <Button
                  variant={
                    localProviders["Screw"] === "Doctor" ? "default" : "outline"
                  }
                ...
                <Button
                  variant={
                    localProviders["Screw"] === "Lab" ? "default" : "outline"
                  }
              ...
              <div className="flex gap-2">
                ...
                <Button
                  variant={
                    localProviders["Ti-base"] === "Lab" ? "default" : "outline"
                  }
            ...
            <>
              ...
              {localAbutmentMaterial === "Titanium Custom Abutment" && (
                <>
                  ...
                  <Button
                    onClick={() => setProviderFor("Premilled", "Doctor")}
                    variant={
                      localProviders["Premilled"] === "Doctor"
                        ? "default"
                        : "outline"
                    }
                  >
                  ...
                  <Button
                    onClick={() => setProviderFor("Premilled", "Lab")}
                    variant={
                      localProviders["Premilled"] === "Lab"
                        ? "default"
                        : "outline"
                    }
                  >
            ...
            <>
              ...
              {showCementQuestion && (
                <>
                  ...
                  <Button
                    onClick={() => setProviderFor("Cement", "Doctor")}
                    variant={
                      localProviders["Cement"] === "Doctor"
                        ? "default"
                        : "outline"
                    }
                  >
                  ...
                  <Button
                    onClick={() => setProviderFor("Cement", "Lab")}
                    variant={
                      localProviders["Cement"] === "Lab" ? "default" : "outline"
                    }
                  >
                    Lab
                  </Button>
        ...
        <div className="flex justify-end gap-2 mt-4">
          ...
          <Button
            ...
            className={isSaveEnabled() ? "" : "opacity-50 cursor-not-allowed"}
          >
            Save
          </Button>
        </div>
