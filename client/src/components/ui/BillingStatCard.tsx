    ...
    {isTotalDue ? (
      ...
      <div className="flex h-full">
        <div className="flex-1 flex flex-col justify-center">
          ...
          <div className="text-2xl leading-none font-bold text-yellow-500">
            {value}
          </div>
        </div>
        <div className="w-px bg-gray-300 mx-4" />
        <div className="flex-1 flex flex-col justify-center">
          <div className="text-base font-medium text-gray-700 mb-1">{subtext}</div>
          <div className="text-2xl leading-none font-bold text-yellow-500">
            {subvalue}
          </div>
        </div>
      ...
      <>
        ...
        {subtext && subvalue && (
          <div className="text-sm text-muted-foreground">
            {subtext}: <span className="font-semibold text-black">{subvalue}</span>
          </div>
        )}
